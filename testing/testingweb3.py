...
summary_frame.grid(row=0, column=0, sticky="nw", padx=10, pady=10)
...
entry_position.grid(row=2, column=1, padx=5, pady=5, sticky="ew")

tk.Label(input_frame, text="Status:").grid(row=3, column=0, sticky="w")
entry_status = ttk.Combobox(input_frame, values=["Applied", "In Progress", "Offer", "Interview", "Rejected"])
entry_status.grid(row=3, column=1, padx=5, pady=5, sticky="ew")

tk.Label(input_frame, text="Job Link:").grid(row=4, column=0, sticky="w")
entry_job_link = tk.Entry(input_frame)
entry_job_link.grid(row=4, column=1, padx=5, pady=5, sticky="ew")

tk.Label(input_frame, text="Job Site:").grid(row=5, column=0, sticky="w")
entry_job_site = tk.Entry(input_frame)
entry_job_site.grid(row=5, column=1, padx=5, pady=5, sticky="ew")

tk.Label(input_frame, text="Notes:").grid(row=6, column=0, sticky="w")
entry_notes = tk.Entry(input_frame)
entry_notes.grid(row=6, column=1, padx=5, pady=5, sticky="ew")

tk.Button(input_frame, text="Submit", command=submit).grid(row=7, column=0, pady=10, sticky="ew")
tk.Button(input_frame, text="Clear", command=clear_form).grid(row=7, column=1, pady=10, sticky="ew")
tk.Button(input_frame, text="Open Link", command=open_link).grid(row=8, column=0, columnspan=2, pady=10, sticky="ew")

# Search Frame
search_frame = ttk.Frame(main_frame, padding="10")
search_frame.grid(row=1, column=1, sticky="nw", padx=10, pady=10)
...
table_frame.grid(row=2, column=0, columnspan=2, pady=10, sticky="nsew")
...
# Make sure the table expands properly
